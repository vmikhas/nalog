export const headerContent = {
    ...
    desc: 'В России выигрыш считается доходом физических лиц, поэтому победители платят подоходный налог (НДФЛ), как с зарплаты. На&nbsp;этой странице мы объясним,<br/> сколько и когда нужно заплатить государству, чтобы спать&nbsp;спокойно.',
    logo: {
        imgAttr: {
...
export const calculateContent = {
    ...
    carouselDesc: {
        ...
        average: 'Налог — 13 %, но учитывается только часть выигрыша: 4000 ₽ в&nbsp;год налогом не облагаются. Заплатить государству нужно самостоятельно.',
