...
export const payContent = {
    ...
    subtitle: {
        one: 'Заполните декларацию 3-НДФЛ',
        two: 'Подайте декларацию в налоговую инспекцию',
        three: 'Оплатите налог'
    },
    desc: {
        one: '<p class="pay__desc_p">Это можно сделать в личном кабинете на <a class="pay__link" href="https://lkfl2.nalog.ru/lkfl" target="_blank">сайте ФНС.</a></p>' +
        ...
        two: 'Электронный документ можно отправить в налоговую в личном кабинете сразу после его заполнения. Если вы заполняли форму от руки, бумажный бланк придётся отнести в <a class="pay__link" href="https://service.nalog.ru/addrno.do" target="_blank">отделение налоговой по месту жительства</a>. Приготовьте два экземпляра документа.',

        three: '<p class="pay__desc_p>Проще всего это сделать там же, где подавали декларацию: в личном кабинете налогоплательщика или в отделении налоговой.</p>' +
